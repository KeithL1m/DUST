...
| yt-ideas | `/yt-ideas` | Anime research digest from current buzz (volume + YouTube-saturation signals, no channel-fit filtering or pitching); `deep-dive <topic>` expands one topic — saves to `content/` (gitignored) |
